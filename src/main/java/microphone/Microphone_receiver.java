...
public class Microphone_receiver {
    private static final String MEETING_MICROPHONE_FOLDER_PATH = "src/main/resources/microphone/";
    ...
    public static synchronized String get_specified_screenshot_folder(String joiner_data) {
        ...
        File meeting_folder = new File (MEETING_MICROPHONE_FOLDER_PATH + meeting_id);
